...
def _format_markdown_report(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        (
            ...
            "contract is Model A V2 / EthosSafeDetV2: seven-class detection with bbox and "
        ...
        "",
        "Model A V2 / EthosSafeDetV2 is the active system contract for seven desktop object categories in "
        ...
        *_class_rows(data),
        "",
        "The class distribution is not perfectly balanced. `phone`, `earbud`, and `bottle` dominate the current set, "
        "while `phial`, `remote`, `tissue`, and `apple` have fewer examples. This imbalance should be considered when "
